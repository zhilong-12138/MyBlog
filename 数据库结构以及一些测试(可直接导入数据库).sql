...
CREATE TABLE `article` (
  ...
  `originalAuthor` varchar(200) NOT NULL,
  `articleTitle` varchar(200) NOT NULL,
  `articleContent` longtext NOT NULL,
  `articleTags` varchar(200) NOT NULL,
  `articleType` varchar(200) NOT NULL,
  `articleCategories` varchar(200) NOT NULL,
...
CREATE TABLE `feedback` (
  ...
  `feedbackDate` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `leave_message_record` (
  ...
  `answererId` int(11) NOT NULL,
  `respondentId` int(11) NOT NULL,
  `leaveMessageDate` varchar(200) NOT NULL,
  `likes` int(11) NOT NULL,
...
CREATE TABLE `privateword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `privateWord` varchar(200) NOT NULL,
  `publisherId` varchar(200) NOT NULL,
  `replierId` varchar(200) DEFAULT NULL,
  `replyContent` varchar(200) DEFAULT NULL,
  `publisherDate` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `reward` (
  ...
  `rewardUrl` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `user` (
  ...
  `personalBrief` varchar(200) DEFAULT NULL,
  `avatarImgUrl` text NOT NULL,
  `recentlyLanded` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '19940790216', '周志龙', 'a3caed36f0fe5a01e5f144db8927235e', 'male', '周志龙', '1997-07-05', '1125694337@qq.com', '', 'https://zhy-myblog.oss-cn-shenzhen.aliyuncs.com/public/user/avatar/周志龙/1575283189.png', '2019-12-02 18:31:15');
